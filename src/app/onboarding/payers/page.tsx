  ...
  return (
    <div className="min-h-screen bg-gray-950 text-white">
      <div className="max-w-2xl mx-auto px-6 py-12">
        <Link href="/onboarding" className="text-xs text-gray-400 hover:text-gray-300 mb-8 block">
          ← Back to setup
        </Link>
              ...
              >
                ...
                >
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <div className="text-xs text-gray-400">{payer.id}</div>
                  </div>
                </button>
        ...
        <div className="mt-6 flex items-center justify-between">
          <Link href="/onboarding" className="text-xs text-gray-400 hover:text-gray-300">
            Skip for now
          </Link>
          <button
            onClick={handleSave}
