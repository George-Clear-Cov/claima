...
export default function BaaGate({ baaAccepted }: BaaGateProps) {
  ...
  return (
    <div className="fixed inset-0 z-[100] bg-black/60 flex items-center justify-center p-4">
      <div role="dialog" aria-modal="true" aria-labelledby="baa-gate-title" className="bg-white rounded-2xl shadow-xl max-w-lg w-full p-8">
        ...
        <h2 id="baa-gate-title" className="text-xl font-bold text-gray-900 mb-2">Business Associate Agreement Required</h2>
